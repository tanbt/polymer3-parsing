...
public class App {
    public static void main(String[] args) {
        ...
        InputStream stream = App.class.getClassLoader()
                .getResourceAsStream("p3test-app.js");
        ...
        try {
            SourceFile sourceFile = SourceFile
                    .fromInputStream("p3test-app.js", stream,
                            Charset.defaultCharset());
            ParserRunner.ParseResult parseResult = ParserRunner
                    .parse(sourceFile, sourceFile.getCode(), config,
                            errorReporter);
            ...
            // template
            String javascript = new CodePrinter.Builder(parseResult.ast)
                    .build();
